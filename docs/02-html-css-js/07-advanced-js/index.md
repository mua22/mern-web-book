...
1. [Module 1: OOP Fundamentals](./01-oop-fundamentals.md)
   - Object Literals
   - Factory vs. Constructor functions
   - The `this` keyword demystified
2. [Module 2: Prototypical Inheritance](./02-prototypical-inheritance.md)
   - Prototypes and the Prototype Chain
   - Multi-level inheritance setups
   - Method overriding
3. [Module 3: ES6+ Features](./03-es6-features.md)
   - ES6 Classes (Syntactic sugar)
   - Arrow Functions
   - Destructuring, Spread/Rest syntax
   - Template Literals
4. [Module 4: Asynchronous JavaScript](./04-async-javascript.md)

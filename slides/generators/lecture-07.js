...
buildDeck({
  ...
  slides: [
    ...
    { type: "codeImageSide", kicker: "The Positioning Schemes", heading: "Five Ways to Lay Out an Element",
      ...
      img: `${IMG}/position-overview.png` },

    { type: "codeImageSide", kicker: "Scheme 1 of 4", heading: "relative",
      code: ".box {\n  position: relative;\n  top: 10px;\n  left: 20px;\n}",
      img: `${IMG}/relative-demo.png` },

    { type: "codeImageSide", kicker: "Scheme 2 of 4", heading: "absolute",
      code: ".box {\n  position: absolute;\n  top: 0;\n  right: 0;\n}",
      img: `${IMG}/absolute-demo.png` },

    { type: "codeImageSide", kicker: "Scheme 3 of 4", heading: "fixed",
      code: ".back-to-top {\n  position: fixed;\n  bottom: 20px;\n  right: 20px;\n}",
      img: `${IMG}/fixed-demo.png` },

    { type: "codeImageSide", kicker: "Scheme 4 of 4", heading: "sticky",
      code: ".section-heading {\n  position: sticky;\n  top: 0;\n}",
      img: `${IMG}/sticky-demo.png` },
